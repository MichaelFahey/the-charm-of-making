...
/**
 *  Class Customize_Alpha_Color_Control
 *    the class for the color control
 */
class Customize_Alpha_Color_Control extends WP_Customize_Control {
	 ...
	 *
	 * @var type - Official control name.
	 */
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_template_directory_uri() . '/admin/customizer/alpha-color-picker/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_template_directory_uri() . '/admin/customizer/alpha-color-picker/alpha-color-picker.css',
